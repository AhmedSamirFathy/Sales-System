...
class Admin:
    ...
    def back_product_to_market(self):
        try:
            ...
            return
        if self.get_returns_to_market_product == "" or self.get_returns_to_market_quantity == "" or self.get_returns_to_market_unitprice == "" :
            messagebox.showerror("خطأ", "من فضلك ادخل معلومات صحيحة")
        elif self.get_returns_to_market_date == "":
            messagebox.showerror("خطأ", "من فضلك ادخل معلومات صحيحة")
            return 
    ...
    def back_product_to_store(self):
        ...
        if self.get_back_storeroom_num == "" or self.get_back_to_store_product == "" or self.get_back_to_store_quantity == "":
            messagebox.showerror("خطأ", "من فضلك ادخل معلومات صحيحة")
        elif self.get_back_to_store_unitprice == "" or self.get_back_sell_date == "":
            messagebox.showerror("خطأ", "من فضلك ادخل معلومات صحيحة")
        ...
        if self.get_back_to_store_product in self.ex_product_in_sales:
            ...
            if self.get_back_to_store_product in self.check_products_in_stores:
                ...
                if self.get_back_storeroom_num != self.check_in_store1:
                    self.cur.execute("insert into stores values (?,?,?,?)",
                                     (int(self.get_back_storeroom_num),
                                      str(self.get_back_to_store_product),
                                      int(self.get_back_to_store_quantity),
                                      float(self.get_back_to_store_unitprice)))
